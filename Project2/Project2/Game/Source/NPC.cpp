...
bool NPC::Update(float dt)
{
	...
	{
		if (OnCollisionStay(this->pbody, app->scene->player->pbody) && (app->input->GetKey(SDL_SCANCODE_E) == KEY_DOWN || pad.y) && app->dialogueManager->isTalking == false && app->scene->isOnCombat == false)
		{
			app->audio->PlayFx(app->scene->clickFx);
